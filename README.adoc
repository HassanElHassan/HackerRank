...
* Due to the nature of Python and R the majority of these challenges can easily be solved using built-in functions or libraries, to keep it a challenge, these were avoided.
